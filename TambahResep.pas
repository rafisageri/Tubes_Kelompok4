...
interface 
  ...
  Procedure TambahResepBaru(NamaResep : string; MentahResep : Mresep; OlahanResep : Oresep; HargaResep : integer; BahanMentah : TabMentah;  BahanOlahan : TabOlahan; var ResepJadi : tabresep; ResepValid : boolean; CountEnergi : boolean; var Energi : integer);
  ...
  if (ResepValid) then begin 
    CekEnergi(Energi, CountEnergi); 
	  if (not(CountEnergi)) then begin 
	    writeln('Pembuatan resep gagal, energi tidak mencukupi'); 
	  end else begin 
