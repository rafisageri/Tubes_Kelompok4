...
interface 
  ...
  Procedure MenjualResep(var BahanMentah : ListInventoriM; var BahanOlahan : ListInventoriO; ResepJadi : tabresep; var Energi : integer; var Pendapatan : integer; Nsim : integer); 
...
implementation 
 ...
 begin //Algoritma
  ...
  var //Kamus Lokal
  i , JumlahJualR : integer;
  JualR : string;  
  FoundResep , FoundMentah , FoundOlahan , CountMentah , CountOlahan  : boolean; 
  Begin //Algoritma
