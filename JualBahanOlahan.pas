...
interface 
  ...
  Procedure MenjualOlahan(JualO : String; FoundOlahan : Boolean; JumlahJualO : integer; BahanOlahan : ListInventoriO; CountOlahan : boolean; CountEnergi : boolean; var Energi : integer; var Pendapatan : integer; Nsim : integer); 
